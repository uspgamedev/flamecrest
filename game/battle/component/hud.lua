...
function hud:load (context, graphics)
  ...
  -- Load tileset images
  self.tileset.marker = graphics.newImage "resources/images/hextile-empty.png"
...
local function drawmarker (mappos, context, graphics)
  ...
  if haseffect then
    graphics.draw(hud.tileset.marker, pos.x, pos.y, 0, 1, 1, 64, 32)
    graphics.setPixelEffect()
  end
end

local function drawmodifier (name, pos, graphics)
  local image = hud.tileset[name]
